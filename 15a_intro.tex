...
\hline
\multicolumn{2}{p{\dimexpr\textwidth-2\tabcolsep\relax}}
{\footnotesize continua na próxima página\protect}
\endfoot%
...
\subsection{Testando se referências quebram}
Nos parágrafos a seguir, espera-se que a (última) preposição \enquote{na} e a
referência (Figura 1, Tabela 1, etc.) apareçam na mesma linha, sem hifenização.

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na na na \autoref{fig:ex01}, tem-se\ldots

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na na na \autoref{quad:quadro_modelo1}, tem-se\ldots

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na na na \autoref{tab:SimulationResults}, tem-se\ldots

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na na \autoref{fig:ex01}, tem-se\ldots

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na na \autoref{quad:quadro_modelo1}, tem-se\ldots

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na na \autoref{tab:SimulationResults}, tem-se\ldots

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na \autoref{fig:ex01}, tem-se\ldots

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na \autoref{quad:quadro_modelo1}, tem-se\ldots

Por exemplo, vou inserir um monte de texto aqui para causar uma quebra
na \autoref{tab:SimulationResults}, tem-se\ldots
...
\abnTeX{}~\cite{abntex2classe,abntex2cite,abntex2cite-alf}
