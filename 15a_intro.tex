...
% Start alternating colors ONLY for the data rows
% Row 1 = header, row 2 = \endfirsthead header, row 3 = page-head, etc.
% The first actual data row in your table is the one starting with "Cor"
...
% Reset to avoid affecting later tables
\rowcolors{4}{}{}
...
Por exemplo, na \figref{fig:ex01}, tem-se\ldots
