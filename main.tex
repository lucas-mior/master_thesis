...
\begin{document}
    ...
    \ifforcedinclude\else
        ...
        \abntex2PRIVATEbookmarkthis{Capa}
        ...
        \addtotextpreliminarycontent{\abntex2folhaderostoname}
        \abntex2imprimirfolhaderosto*{}
        ...
        \abntex2PRIVATEbookmarkthis{Ficha Catalográfica}
    ...
    % Dedicatória
    \ifforcedinclude\else\cleardoublepage\fi
    \ifforcedinclude\else\input{05_dedicatoria.tex}\fi
    ...
    \ifforcedinclude\else\cleardoublepage\fi
    \include{12_siglas.tex}

    % Inserir lista de símbolos
    \ifforcedinclude\else\cleardoublepage\fi
    \include{13_simbolos.tex}
    ...
    \begin{apendicesenv}
        ...
        \ifforcedinclude\else\abntex2partapendices\fi
        \setlength\beforechapskip{50pt}
        \setlength\midchapskip{20pt}
        \setlength\afterchapskip{20pt}
    ...
    \begin{anexosenv}
        ...
        \ifforcedinclude\else\abntex2partanexos\fi
        \setlength\beforechapskip{50pt}
        \setlength\midchapskip{20pt}
        \setlength\afterchapskip{20pt}
