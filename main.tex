...
\makenoidxglossaries
\simbololista{E_min}{\ensuremath{E_{min}}}{Minimum energy}
\simbololista{alpha}{\ensuremath{\alpha}}{Alpha particle}
\simbololista{F}{\ensuremath{F}}{Force}
\simbololista{rho}{\ensuremath{\rho}}{Density}
...
\ABNTEXlocal{%
  \brazilword{Florianópolis, Santa Catarina} -- \lang{Brazil}{Brasil}
}
...
\ABNTEXtipotrabalho{\lang{Bachelor\s Thesis}{Trabalho de Conclusão de Curso}}
...
\newcommand{\xLeftarrow}[2][]{%
  \ext@arrow 0359\Leftarrowfill@{#1}{#2}%
}
\makeatother
...
\begin{document}
  ...
  % PARTE
  \ifforcedinclude\else
    \part{\lang{Implementation}{Implementação}}
  \fi
  \label{segunda_parte}
